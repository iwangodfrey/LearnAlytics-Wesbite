document.addEventListener("DOMContentLoaded", function () {
    ...
    navItems.forEach((item) => {
      item.addEventListener("mouseover", function () {
        this.querySelector("a").classList.add("hovered");
      });
  
      item.addEventListener("mouseout", function () {
        this.querySelector("a").classList.remove("hovered");
      });
    });
  });
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCarousel() {
      ...
      const newTransformValue = -currentIndex * boxWidth + 'px'; 
...
signupButton.addEventListener('mouseover', function () {
  // Add the hover effect class when the mouse is over the button
  signupButton.classList.add('hover-effect');
});

signupButton.addEventListener('mouseout', function () {
  // Remove the hover effect class when the mouse leaves the button
  signupButton.classList.remove('hover-effect');
});
